...
test('collector score can remain high when economics are weak', async()=>{
  ...
  const opportunity=opportunityScore({cards:52,treatment:94,audience:96,supply:45,adjustedEvScore:ev,liquidity:55,confidence:.7,valueConcentrationRisk:55,reprintCompressionPenalty:45});
...
test('opportunity confidence discounts uncertainty rather than manufacturing upside', async()=>{
  const base={cards:88,treatment:90,audience:92,supply:82,adjustedEvScore:90,liquidity:86,valueConcentrationRisk:20,reprintCompressionPenalty:15};

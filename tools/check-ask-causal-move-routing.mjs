...
for(const token of ['identity?.move_selection','c.sku_id=text(move.sku_id)','selection_reason:\'recent_market_move_evidence\'','c.causal_family']){
  if(!api.includes(token))throw new Error(`missing recovered causal SKU handoff: ${token}`);
}

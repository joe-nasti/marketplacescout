...
if(!/canonical_family_skus_not_found/.test(presenter)||!/handled:true/.test(presenter))throw new Error('stock questions must not fall through to generic printing clarification');

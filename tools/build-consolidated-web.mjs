...
const jsFiles=[
  ...
  'current-scout-parity.js','current-seller-parity.js','current-syp-parity.js',
...
const cssFiles=[
  ...
  'current-ux.css','current-scout-parity.css','current-seller-parity.css','current-syp-parity.css'
];

...
const presentV3=read('supabase/functions/ask-collectish-delvin-present-v3/index.ts');
...
if(!discord.includes('ask-collectish-delvin-present-v3'))throw new Error('Discord does not use immutable shared presentation v3');
if(!webApi.includes('ask-collectish-delvin-present-v3'))throw new Error('web persisted facade does not use immutable shared presentation v3');
if(!presentV3.includes('../ask-collectish-delvin-present-v2/index.ts'))throw new Error('presentation v3 does not bundle the reconciled v2 implementation');

...
with recent as (
  select distinct
    ...
    i.source_url,i.source_name,i.signal_stage,i.direction,
  ...
  select user_id,product_id,
    ...
    max(signal_at) latest_signal_at,round(sum(direction_weight*confidence*stage_weight*recency_weight),3) weighted_net

// Collectish consolidated web 0.8.2
...
(()=>{
  ...
  if(realBadge)realBadge.textContent='web 0.8.2';
  window.__collectishConsolidated={version:'0.8.2',builtAt:'2026-08-15T23:46:08.510Z'};
})();
...
(()=>{
  const b=document.querySelector('#appVersion');if(b)b.textContent='web 0.8.2';

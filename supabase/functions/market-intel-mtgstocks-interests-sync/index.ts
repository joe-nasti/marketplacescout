...
Deno.serve(async(req:Request)=>{
  ...
  try{
    ...
    if(!all.length){
      return J({error:'MTGStocks API is unavailable from Supabase edge egress; canonical Interests are collected by the GitHub Chrome collector.',api_rows:0,fallback:false,errors},502);
    }

...
Deno.serve(async(req:Request)=>{
  ...
  try{
    ...
    let transcriptAttempts=0,billableCredits=0,saved=0,duplicates=0,unavailable=0,failed=0,skipped=0;const report:any[]=[];
    outer: for(const sub of enabled){
      ...
      const out:any={source:sub.source,channel_id:channelId,lane,scanned:0,fetched:0,saved:0,duplicates:0,unavailable:0,failed:0};
      try{
    ...
    return J({ok:true,subscriptions:enabled.length,max_transcripts:maxTranscripts,transcript_attempts:transcriptAttempts,billable_credits_observed:billableCredits,saved,duplicates,unavailable_native:unavailable,failed,skipped,policy:{transcript_mode:'native',ai_generation:false,per_run_cap:maxTranscripts},report});

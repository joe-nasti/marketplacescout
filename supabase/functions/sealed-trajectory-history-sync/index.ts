...
Deno.serve(async req=>{
  ...
  try{
    ...
    const requestedRange=String(body?.range||'annual'),range=requestedRange==='year'?'annual':(['quarter','annual'].includes(requestedRange)?requestedRange:'annual');

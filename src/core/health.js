...
export function renderRuntimeHealth(){
  ...
  box.innerHTML=`<div class="cx-section-title">Runtime health</div><div class="cx-detail-list">
    ...
    <div class="cx-detail-stat"><span>Signals primary data</span><strong>${fmtMs(metrics.signals_primary_data_ms)}</strong><small>${Number(metrics.signals_primary_items||0)} items</small></div>
    <div class="cx-detail-stat"><span>Signals primary render</span><strong>${fmtMs(metrics.signals_primary_render_ms)}</strong></div>
    <div class="cx-detail-stat"><span>Signals primary ready</span><strong>${fmtMs(metrics.signals_primary_ready_ms)}</strong><small>Data + visible render</small></div>

...
registerComponent('scout-detail-links',{
  mount(){document.addEventListener('collectish:scout-v5-ready',schedule);document.addEventListener('collectish:scout-detail-rendered',decorateScoutDetailLinks);document.addEventListener('click',onClick,true)},
  unmount(){document.removeEventListener('collectish:scout-v5-ready',schedule);document.removeEventListener('collectish:scout-detail-rendered',decorateScoutDetailLinks);document.removeEventListener('click',onClick,true)},

...
function render(data,days){
  ...
  const covered=[coverage.tcg_price_history&&'price',coverage.tcg_sales_history&&'sales',coverage.cardkingdom_depth&&'CK',coverage.syp&&'SYP',coverage.signals&&'signals'].filter(Boolean);

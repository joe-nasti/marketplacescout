...
function sourceLabel(source){
  ...
  if(source==='tcgplayer_marketplace')return 'TCG';
...
function render(data,days){
  ...
  const covered=[coverage.tcg_price_history&&'price',coverage.tcg_sales_history&&'sales',coverage.cardkingdom_depth&&'CK',coverage.signals&&'signals'].filter(Boolean);

  ...
  idle(()=>{
    ...
    idlePromise=(async()=>{
      await Promise.all([
        ...
        (async()=>{await import('./ask/context.js');await import('./ask/endpoint-proxy.js');await import('./ask/main.js');await import('./ask/streaming.js');await import('./ask/sales-history-surface.js');await loadParallel(askEnhancers)})()
      ]);

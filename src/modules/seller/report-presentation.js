...
function sync(){
  ...
  h.classList.add('cx-seller-report-presentation');h.dataset.sellerReportTab=tab();
...
export function installSellerReportPresentation(){

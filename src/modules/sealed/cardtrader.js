...
async function renderCardTrader(event){
  ...
  const raw=row.raw_json||{},ct=raw.ct||{},zero=raw.ct_zero||{},model=raw.landed_model||{},currency=raw.currency||'USD';

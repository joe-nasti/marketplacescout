...
function trendLabel(signal){return({tightening_strong:'Strong tightening',tightening:'Tightening',loosening:'Loosening',stable:'Stable',building_history:'Building history'})[signal]||'Building history'}
...
async function renderCardTrader(event){
  ...
  const raw=row.raw_json||{},ct=raw.ct||{},zero=raw.ct_zero||{},model=raw.landed_model||{},trend=raw.ct_zero_trend||{},primary=trend.primary||{},currency=raw.currency||'USD';

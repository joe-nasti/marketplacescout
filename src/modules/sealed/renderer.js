...
async function loadDetailData(r,force=false){
  ...
  return loadResource(`sealed.detail:v11:${r.sealed_uuid}`,async()=>{
    const [cards,price,contents,children,analogs,backtests,lifecycles,transitions,calibration,similarity]=await Promise.all([
